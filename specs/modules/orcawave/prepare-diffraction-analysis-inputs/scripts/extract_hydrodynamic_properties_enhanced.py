...
Enhanced version with windload_heel configuration and 4-decimal rounding
...
def extract_vessel_properties(excel_path: str, draft_ft: float = None, include_windload_heel: bool = True) -> List[Dict[str, Any]]:
    """
    ...
    Args:
        ...
        include_windload_heel: Whether to include the windload_heel configuration
    ...
    # Add windload_heel configuration if requested
    if include_windload_heel:
        add_windload_heel_config(vessels, draft_ft)
...
def main():
    ...
    vessels = extract_vessel_properties(str(excel_file), draft_ft=None, include_windload_heel=True)
