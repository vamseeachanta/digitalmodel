...
- [x] Create `__main__.py` for direct module execution (`python -m digitalmodel.workflows.automation.go_by_folder`)
...
- [x] Add entry point to pyproject.toml: `create-go-by = "digitalmodel.workflows.automation.go_by_folder.cli:main"`
...
3. Python module: `python -m digitalmodel.workflows.automation.go_by_folder`
