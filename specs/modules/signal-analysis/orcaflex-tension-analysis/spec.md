...
python -m digitalmodel.signal_processing.signal_analysis.timeseries_analyzer \
...
### Python API
```python
from digitalmodel.signal_processing.signal_analysis import TimeSeriesAnalyzer
...
- digitalmodel.signal_processing.signal_analysis.core.spectral
