...
This plan outlines how to prepare OrcaFlex models in .yml format from scratch using the 18 available OrcaFlex skills and the established component library system.
...
### Model Types Found in Repository (440 files)
...
## 5. Quick Reference: Model Creation Commands
...
2. **Line tensions**: Match expected pretensions
3. **Vessel position**: At target coordinates
