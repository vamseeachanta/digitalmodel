# Iteration 1
# Tension calculation
/d/github/digitalmodel/.venv/Scripts/python -m digitalmodel .yml/dm_ofx_anal_mooring_fsts_l015_125km3_pb.yml
...
/d/github/assetutilities/.venv/Scripts/python -m assetutilities au_collate_pretension_result.yml
