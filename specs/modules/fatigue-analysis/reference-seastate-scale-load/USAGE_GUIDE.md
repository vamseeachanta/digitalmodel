...
python -m digitalmodel.structural.fatigue_analysis.load_scaling specs/modules/fatigue-analysis/reference-seastate-scale-load/input/load_scaling_config.yml
```
