...
from src.digitalmodel.fatigue_analysis.strut_foundation_processor import (
    LoadScaler,
...
class InteractiveVerification:
    ...
    def step5_scaling_calculation(self):
        ...
        try:
            ...
            from src.digitalmodel.fatigue_analysis.strut_foundation_processor import FatigueCondition
