...
python -m digitalmodel.structural.fatigue_analysis --sample --parallel 4
```

### Generate Visualizations
```python
from digitalmodel.structural.fatigue_analysis.visualizer import generate_all_visualizations
