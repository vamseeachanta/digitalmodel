...
from digitalmodel.fatigue_analysis.strut_foundation_processor_with_progress import (
    BatchProcessor
)
...
class PerformanceBenchmark:
    ...
    def benchmark_batch_processing(self) -> None:
        ...
        from digitalmodel.fatigue_analysis.strut_foundation_processor import FatigueCondition
