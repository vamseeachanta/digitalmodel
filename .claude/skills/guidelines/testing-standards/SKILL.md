...
description: Define testing standards for unit, integration, and regression coverage with reliable execution patterns. Use when planning tests, reviewing test quality, or setting project QA baselines.
---
