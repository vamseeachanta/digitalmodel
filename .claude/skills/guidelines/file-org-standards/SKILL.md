...
description: Enforce file organization, naming, and repository layout standards. Use when structuring new work, refactoring folders, or auditing repo consistency.
---
