---
name: dev-workflow
description: Apply standardized development workflow from planning through implementation, validation, and handoff. Use when executing day-to-day engineering tasks with repeatable process controls.
---
