---
name: codex-review
description: Run Codex-based code and plan reviews with consistent criteria, reporting, and follow-up actions. Use when requesting structured technical review from Codex workflows.
---
