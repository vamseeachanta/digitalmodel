---
name: gemini-review
description: Run Gemini-based reviews with consistent prompts, scope, and result interpretation. Use when requesting complementary analysis from Gemini in multi-review workflows.
---
