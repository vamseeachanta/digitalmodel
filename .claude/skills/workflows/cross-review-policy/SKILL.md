...
description: Enforce cross-review policy across multiple AI reviewers with clear escalation and reconciliation rules. Use when coordinating multi-agent reviews for plans, code, or commits.
---
