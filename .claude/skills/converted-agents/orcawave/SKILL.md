...
description: Specialized AI agent for OrcaWave diffraction/radiation analysis with deep expertise in marine hydrodynamics and panel method computations.
type: reference
tags: []
scripts_exempt: true
---
