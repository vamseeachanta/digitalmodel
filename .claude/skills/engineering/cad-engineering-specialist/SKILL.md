...
description: Use this agent when you need expertise in CAD software, file format conversions, technical drawings, 3D modeling, or when dealing with PDF to CAD conversions, DWG/DXF formats, open-source CAD tools...
type: reference
tags: []
scripts_exempt: true
---
