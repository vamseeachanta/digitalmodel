#!/usr/bin/env python
"""
tug_30m_1 OrcaWave Configuration Analysis & Troubleshooting
Analyzes the actual tug_30m_1_diffraction.yml configuration
"""
...
def generate_report(all_issues, all_recommendations):
    ...
    # Save report to file
    report_path = Path("tug_30m_1_analysis_report.txt")
    with open(report_path, 'w') as f:
        f.write("TUG_30M_1 ORCAWAVE CONFIGURATION ANALYSIS\n")
        f.write("="*60 + "\n\n")
        f.write(f"Configuration File: tug_30m_1_diffraction.yml\n")
        f.write(f"Panel Count: 24,332\n")
        f.write(f"Vessel Type: Tug (tug_30m_1)\n\n")
...
def main():
    ...
    config_path = Path("D:/github/digitalmodel/specs/modules/orcawave/diffraction-analysis/configs/tug_30m_1_diffraction.yml")
    
    print("="*70)
    print(" TUG_30M_1 ORCAWAVE CONFIGURATION ANALYSIS ")
    print("="*70)
    ...
    # Generate optimized configuration
    opt_path = Path("tug_30m_1_optimized.yml")
    ...
    print("="*70)
    print("\nNext Steps:")
    print("1. Review the detailed report: tug_30m_1_analysis_report.txt")
    print("2. Use optimized config: tug_30m_1_optimized.yml")
    print("3. Run quick fix: python mcp_orcawave.py quick-fix tug_30m_1.owd")
