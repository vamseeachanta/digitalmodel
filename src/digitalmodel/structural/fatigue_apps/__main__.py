...
Usage:
    python -m digitalmodel.structural.fatigue_apps [options]
    
Examples:
    # Run with default production data
    python -m digitalmodel.structural.fatigue_apps
    
    # Run with specific input directory
    python -m digitalmodel.structural.fatigue_apps --input-directory ./data
    
    # Run with sample data for testing
    python -m digitalmodel.structural.fatigue_apps --sample --timesteps 1000
    
    # Run specific configurations
    python -m digitalmodel.structural.fatigue_apps --configs fsts_l015,fsts_l095
"""
