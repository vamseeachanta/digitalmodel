...
class LoadScalingProcessor:
    ...
    def save_outputs(self):
        ...
        efficient_module_path = os.path.join(parent_dir, 'digitalmodel', 'structural', 'fatigue_apps')
...
Examples:
    ...
    python -m digitalmodel.structural.fatigue_apps.load_scaling config.yml
