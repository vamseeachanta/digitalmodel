...
ηsx_simp=σG_xx/σscrx_simp
FALSE=σG_yy/σscry_simp
ηsz_simp=τ_G/σscrz_simp
...
ηux_simp=σG_xx/σucrx_simp1
ηuy_simp=σG_yy/σucry_simp2
ηuz_simp=τ_G/σucrz_simp1
...
ηsx_side=σG_xx/σscrx_side
ηsy_side=σG_yy/σscry_side
ηsz_side=τ_G/σscrz_side
...
ηux_side=σG_xx/σucrx_side1
ηuy_side=σG_yy/σucry_side2
ηuz_side=τ_G/σucrz_side1
...
σ_yrd=σy_rd
τ_rd=τrd
x15=(σG_xx/σ_xrd)**2+(σG_yy/σ_yrd)**2-ci_2*(σG_yy/σ_xrd)*(σG_yy/σ_yrd)+(τ_G/τ_rd)**2
...
Longitudinal=σG_xx/σxrd
Transverse=σG_yy/σy_rd
Shear=τ_G/τ_rd
Biaxial=sqrt(x15)
