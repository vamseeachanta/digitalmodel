...
Moved from infrastructure/base_configs/config_models.py in Phase 2A (WRK-415).
"""
...
# Import structure: from digitalmodel.infrastructure.config.models import ConfigModel
try:
