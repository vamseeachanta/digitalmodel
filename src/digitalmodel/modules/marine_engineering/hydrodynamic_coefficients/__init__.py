...
Example:
    >>> from digitalmodel.modules.marine_engineering.hydrodynamic_coefficients import CoefficientDatabase
    >>>
    >>> # Load from CSV files
    ...
    >>> from digitalmodel.modules.marine_engineering.hydrodynamic_coefficients import HydrodynamicPlotter
