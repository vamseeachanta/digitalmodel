...
class OrcaFlexLogger:
    ...
    def setup(cls,
        ...
        root_logger = logging.getLogger('digitalmodel.modules.orcaflex')
    ...
    def get_logger(cls, name: str) -> logging.Logger:
        ...
        if name not in cls._loggers:
            ...
            if not name.startswith('digitalmodel.modules.orcaflex'):
                name = f'digitalmodel.modules.orcaflex.{name}'
