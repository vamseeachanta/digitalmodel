...
Examples:
  ...
  python -m digitalmodel.modules.orcaflex.modular_input_validation.cli file.yml --skip-level 3

  # Customize tolerance and output formats
  python -m digitalmodel.modules.orcaflex.modular_input_validation.cli file.yml --tolerance 15 --formats csv markdown html

  # Validate with custom data directory
  python -m digitalmodel.modules.orcaflex.modular_input_validation.cli file.yml --data-dir /path/to/data
        """
    )
