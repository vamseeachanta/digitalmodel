...
try:
    from digitalmodel.modules.marine_analysis.wave_spectra import WaveSpectrum, JONSWAP
    ...
    from digitalmodel.modules.marine_analysis.mooring_analysis import MooringSystem
    from digitalmodel.modules.marine_analysis.catenary import CatenarySolver
