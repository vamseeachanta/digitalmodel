...
Modern API (recommended):
    from digitalmodel.modules.marine_analysis.catenary import CatenarySolver, CatenaryInput
    solver = CatenarySolver()
    result = solver.solve(params)

Lazy-Wave API:
    from digitalmodel.modules.marine_analysis.catenary import LazyWaveSolver, LazyWaveConfiguration
    solver = LazyWaveSolver()
    result = solver.solve(config)

Legacy API (deprecated, for backward compatibility):
    from digitalmodel.modules.marine_analysis.catenary import catenaryEquation
...
try:
    ...
    from digitalmodel.modules.marine_analysis.mooring_analysis.catenary_solver import (
        CatenarySolver,
        CatenaryInput,
        CatenaryResults
    )
