...
Example:
    >>> from digitalmodel.modules.marine_analysis.hydrodynamic_coefficients import CoefficientDatabase
    >>>
    >>> # Load from CSV files
    ...
    >>> from digitalmodel.modules.marine_analysis.hydrodynamic_coefficients import HydrodynamicPlotter
