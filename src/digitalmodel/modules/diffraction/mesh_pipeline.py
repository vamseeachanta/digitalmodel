...
Example usage::
    ...
    from digitalmodel.modules.diffraction.mesh_pipeline import MeshPipeline
...
from digitalmodel.modules.bemrosetta.models import (
    MeshFormat,
    MeshQualityReport,
    PanelMesh,
)
from digitalmodel.modules.diffraction.input_schemas import MeshFormatType
