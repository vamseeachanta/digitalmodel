...
Note: overbend/sagbend stress and stinger-radius calculations live in
``digitalmodel.orcaflex.pipelay_analysis``; this module covers the
installation-integrity screening checks not provided there.
"""
