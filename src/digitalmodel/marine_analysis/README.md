...
python -m digitalmodel.marine_analysis visualize --type integration --input data/

# Analyze Excel data
python -m digitalmodel.marine_analysis analyze --input vessel_data.xlsx
```
...
```bash
python -m digitalmodel.marine_analysis profile [OPTIONS]
...
Examples:
  python -m digitalmodel.marine_analysis profile --module wave_spectra
  python -m digitalmodel.marine_analysis profile --module all --output results/
```
...
```bash
python -m digitalmodel.marine_analysis extract [OPTIONS]
...
Examples:
  python -m digitalmodel.marine_analysis extract --type ocimf --input database.xlsx
  python -m digitalmodel.marine_analysis extract --type hydro --input aqwa_output.lis
```
...
```bash
python -m digitalmodel.marine_analysis validate [OPTIONS]
...
Examples:
  python -m digitalmodel.marine_analysis validate --phase 2
  python -m digitalmodel.marine_analysis validate --phase 2 --output results/
```
...
```bash
python -m digitalmodel.marine_analysis visualize [OPTIONS]
...
Examples:
  python -m digitalmodel.marine_analysis visualize --type integration --input data/
  python -m digitalmodel.marine_analysis visualize --type ocimf --input ocimf_data.csv
```
...
```bash
python -m digitalmodel.marine_analysis analyze [OPTIONS]
...
# Run with coverage
pytest tests/test_module_reorganization.py --cov=digitalmodel.marine_analysis
```
...
- `digitalmodel.catenary`: Catenary mooring analysis
