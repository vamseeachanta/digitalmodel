...
Example:
    >>> from digitalmodel.marine_ops.marine_engineering.hydrodynamic_coefficients import CoefficientDatabase
    >>>
    >>> # Load from CSV files
    ...
    >>> from digitalmodel.marine_ops.marine_engineering.hydrodynamic_coefficients import HydrodynamicPlotter
