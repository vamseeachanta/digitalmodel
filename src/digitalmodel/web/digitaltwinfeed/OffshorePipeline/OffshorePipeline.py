"""Offshore Pipeline RESTful API blueprint for pipeline analysis.

Provides authenticated API endpoints for offshore pipeline data
...
class AppIndex(Resource):
    """Root API resource for the OffshorePipeline service requiring authentication."""
    decorators = [auth.login_required]

    def get(self):
        """Handle GET requests to the OffshorePipeline root endpoint.
