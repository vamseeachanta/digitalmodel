"""Metocean RESTful API blueprint for meteorological and ocean data.

Provides authenticated API endpoints for metocean analysis data
...
class AppIndex(Resource):
    """Root API resource for the Metocean service requiring authentication."""
    decorators = [auth.login_required]

    def get(self):
        """Handle GET requests to the Metocean root endpoint.
