"""Floaters RESTful API blueprint for floating structure analysis.

Provides authenticated API endpoints for floating structure data
...
class AppIndex(Resource):
    """Root API resource for the Floaters service requiring authentication."""
    decorators = [auth.login_required]

    def get(self):
        """Handle GET requests to the Floaters root endpoint.
