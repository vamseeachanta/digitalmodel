"""Fixed Wind Turbine RESTful API blueprint for turbine analysis.

Provides authenticated API endpoints for fixed wind turbine data
...
class AppIndex(Resource):
    """Root API resource for the FixedWindTurbine service requiring authentication."""
    decorators = [auth.login_required]

    def get(self):
        """Handle GET requests to the FixedWindTurbine root endpoint.
