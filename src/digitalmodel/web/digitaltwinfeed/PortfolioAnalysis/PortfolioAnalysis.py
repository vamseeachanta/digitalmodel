"""Portfolio Analysis RESTful API blueprint for investment portfolio data.

Provides authenticated API endpoints for portfolio analysis data
...
class AppIndex(Resource):
    """Root API resource for the PortfolioAnalysis service requiring authentication."""
    decorators = [auth.login_required]

    def get(self):
        """Handle GET requests to the PortfolioAnalysis root endpoint.
