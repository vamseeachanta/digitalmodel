"""Fatigue RESTful API blueprint for fatigue analysis.

Provides authenticated API endpoints for fatigue analysis data
...
class AppIndex(Resource):
    """Root API resource for the Fatigue service requiring authentication."""
    decorators = [auth.login_required]

    def get(self):
        """Handle GET requests to the Fatigue root endpoint.
