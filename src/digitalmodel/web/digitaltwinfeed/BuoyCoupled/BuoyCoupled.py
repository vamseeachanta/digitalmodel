"""Buoy Coupled RESTful API blueprint for coupled buoy analysis.

Provides authenticated API endpoints for coupled buoy system data
...
class AppIndex(Resource):
    """Root API resource for the BuoyCoupled service requiring authentication."""
    decorators = [auth.login_required]

    def get(self):
        """Handle GET requests to the BuoyCoupled root endpoint.
