"""Pressure Vessels RESTful API blueprint for pressure vessel analysis.

Provides authenticated API endpoints for pressure vessel data
...
class AppIndex(Resource):
    """Root API resource for the PressureVessels service requiring authentication."""
    decorators = [auth.login_required]

    def get(self):
        """Handle GET requests to the PressureVessels root endpoint.
