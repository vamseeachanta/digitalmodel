"""Pipings RESTful API blueprint for piping system analysis.

Provides authenticated API endpoints for piping analysis data
...
class AppIndex(Resource):
    """Root API resource for the Pipings service requiring authentication."""
    decorators = [auth.login_required]

    def get(self):
        """Handle GET requests to the Pipings root endpoint.
