"""Foundations RESTful API blueprint for foundation analysis.

Provides authenticated API endpoints for structural foundation data
...
class AppIndex(Resource):
    """Root API resource for the Foundations service requiring authentication."""
    decorators = [auth.login_required]

    def get(self):
        """Handle GET requests to the Foundations root endpoint.
