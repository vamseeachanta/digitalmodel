"""FloatingWindTurbine blueprint with data and OrcaFlex endpoints.

Provides RESTful API endpoints for FloatingWindTurbine data retrieval
...
class AppIndex(Resource):
    """Root API resource for the FloatingWindTurbine service requiring authentication."""
    decorators = [auth.login_required]

    def get(self):
        """Handle GET requests to the FloatingWindTurbine root endpoint.
