...
"""Generate Demo 3 end-to-end workflow GIF.
...
the Demo 1 / Demo 2 workflow GIF generators.
...
REPORT_HTML = SCRIPT_DIR.parent / "output" / "demo_03_mudmat_installation_report.html"
OUTPUT_GIF = SCRIPT_DIR / "demo_03_mudmat_installation_workflow.gif"
...
def scene_prompt() -> str:
    ...
    <div class="subtitle">
        The engineer describes the installation screening goal in plain English.<br>
        The agent resolves it to the correct demo and parameters.
    </div>
    <div class="terminal">
        <span class="prompt">user@ace-linux ~/digitalmodel $</span><br>
        <span class="comment"># Ask the AI agent for a deepwater installation analysis</span><br><br>
        <span class="accent">&#9654;</span>
        <span class="cmd"> "Screen mudmat installation feasibility for</span><br>
        <span class="cmd">&nbsp;&nbsp;two construction vessels across 500–3000 m water depth.</span><br>
        <span class="cmd">&nbsp;&nbsp;Cover 3 mudmat sizes (50, 100, 200 te) at 5 sea states.</span><br>
        <span class="cmd">&nbsp;&nbsp;Generate a Go/No-Go heatmap and operability charts."</span>
    </div>
    """
...
def scene_setup() -> str:
    ...
    <div class="subtitle">
        The agent maps the request to the Demo 3 script and resolves dependencies.
    </div>
    <div class="terminal">
        <span class="prompt">agent $</span>
        <span class="output"> Resolving analysis …</span><br>
        <span class="output">  → Script: </span>
        <span class="highlight">examples/demos/gtm/demo_03_deepwater_mudmat_installation.py</span><br>
        <span class="output">  → Vessels: Large CSV 5000te · Medium CSV 2500te</span><br>
        <span class="output">  → Mudmats: 50te (6×6m) · 100te (8×10m) · 200te (12×14m)</span><br>
        <span class="output">  → Depths:  500 · 1000 · 1500 · 2000 · 2500 · 3000 m</span><br>
        <span class="output">  → Cases:  </span>
        <span class="highlight">180</span>
        <span class="output"> (2 vessels × 3 mudmats × 6 depths × 5 Hs)</span><br><br>
        <span class="prompt">agent $</span>
        <span class="cmd"> PYTHONPATH=examples/demos/gtm:src \\</span><br>
        <span class="cmd">&nbsp;&nbsp;uv run python \\</span><br>
        <span class="cmd">&nbsp;&nbsp;examples/demos/gtm/demo_03_deepwater_mudmat_installation.py</span>
    </div>
    """
...
def scene_execution() -> str:
    ...
    <div class="title">5-Phase Installation Screening</div>
    <div class="subtitle">
        180 cases evaluated across all installation phases — lift-off through landing.
    </div>
    <div class="terminal">
        <span class="output">[INFO] Loading vessel data … 2 vessels</span><br>
        <span class="output">[INFO] Loading mudmat structures … 3 sizes</span><br>
        <span class="output">[INFO] Phase 1: Lift-off — crane hook load vs SWL …</span><br>
        <span class="output">[INFO] Phase 2: In-air transit — tilt &amp; sling checks …</span><br>
        <span class="output">[INFO] Phase 3: Splash zone — slamming &amp; buoyancy …</span><br>
        <span class="output">[INFO] Phase 4: Lowering — cable tension &amp; snap loads …</span><br>
        <span class="output">[INFO] Phase 5: Landing — seabed bearing pressure …</span><br><br>
        <div class="progress-row">
            <span class="output" style="min-width:100px">Cases:</span>
            <div class="progress-bar"><div class="progress-fill" style="width:100%"></div></div>
            <span class="success">180 / 180</span>
        </div>
        <div class="progress-row">
        ...
        <span class="success">✓ Screening complete</span>
        <span class="output"> — Go / Marginal / No-Go assigned for all 180 cases</span>
    </div>
    """
...
def scene_report_gen() -> str:
    ...
    <div class="terminal">
        ...
        <span class="highlight">&nbsp;&nbsp;examples/demos/gtm/output/demo_03_mudmat_installation_report.html</span><br><br>
        <span class="success">✓</span>
        <span class="output"> JSON results cached:</span><br>
        <span class="highlight">&nbsp;&nbsp;examples/demos/gtm/results/demo_03_mudmat_installation_results.json</span><br><br>
        <span class="output">Artifacts:</span><br>
        <span class="output">&nbsp;&nbsp;📊 Chart 1 — Go/No-Go Heatmap (hero chart)</span><br>
        <span class="output">&nbsp;&nbsp;📊 Chart 2 — Crane Utilisation vs Water Depth</span><br>
        <span class="output">&nbsp;&nbsp;📊 Chart 3 — DAF vs Water Depth</span><br>
        <span class="output">&nbsp;&nbsp;📊 Chart 4 — Max Hs Limit vs Structure Weight</span><br>
        <span class="output">&nbsp;&nbsp;📊 Chart 5 — Vessel Head-to-Head Comparison</span><br><br>
        <span class="prompt">agent $</span>
        <span class="cmd"> xdg-open examples/demos/gtm/output/demo_03_mudmat_installation_report.html</span>
    </div>
    """
...
def scene_browser_label() -> str:
    ...
    <div class="subtitle">
        ...
        Go/No-Go heatmap, operability envelopes, and full parameter matrix.
    </div>
    """
...
def capture_report_scroll(page) -> list[Image.Image]:
    """Load the real Demo 3 report and capture scroll-through frames."""
...
def main():
    if not REPORT_HTML.exists():
        raise FileNotFoundError(
            ...
            "Run Demo 3 first (or use --from-cache) to generate it."
        )
