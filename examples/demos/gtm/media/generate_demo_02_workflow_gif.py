...
"""Generate Demo 2 end-to-end workflow GIF.
...
the comparison matrix GIF generator.

Usage:
    cd digitalmodel
    uv run python examples/demos/gtm/media/generate_demo_02_workflow_gif.py
"""
...
REPORT_HTML = SCRIPT_DIR.parent / "output" / "demo_02_wall_thickness_report.html"
OUTPUT_GIF = SCRIPT_DIR / "demo_02_wall_thickness_workflow.gif"
...
def scene_prompt() -> str:
    ...
    <div class="terminal">
        ...
        <span class="comment"># Ask the AI agent for a wall thickness analysis</span><br><br>
        <span class="accent">▶</span>
        <span class="cmd"> "Run a multi-code pipeline wall thickness comparison</span><br>
        <span class="cmd">&nbsp;&nbsp;across DNV-ST-F101, API RP 1111, and PD 8010-2.</span><br>
        <span class="cmd">&nbsp;&nbsp;Cover 6 pipe sizes (6″–20″) at 10–25 MPa.</span><br>
...
def scene_setup() -> str:
    ...
    <div class="subtitle">
        The agent maps the request to the Demo 2 script and resolves dependencies.
    </div>
    <div class="terminal">
        <span class="prompt">agent $</span>
        <span class="output"> Resolving analysis …</span><br>
        <span class="output">  → Script: </span>
        <span class="highlight">examples/demos/gtm/demo_02_wall_thickness_multicode.py</span><br>
        <span class="output">  → Codes:  DNV-ST-F101 · API RP 1111 · PD 8010-2</span><br>
        <span class="output">  → Pipes:  6″ 8″ 10″ 12″ 16″ 20″</span><br>
        <span class="output">  → Cases:  </span>
        <span class="highlight">72</span>
        <span class="output"> (6 pipes × 3 codes × 4 pressures)</span><br><br>
        <span class="prompt">agent $</span>
        <span class="cmd"> PYTHONPATH=examples/demos/gtm:src \\</span><br>
        <span class="cmd">&nbsp;&nbsp;uv run python \\</span><br>
        <span class="cmd">&nbsp;&nbsp;examples/demos/gtm/demo_02_wall_thickness_multicode.py</span>
    </div>
    """
...
def scene_execution() -> str:
    ...
    <div class="title">Parametric Analysis Running</div>
    <div class="subtitle">
        72 design cases evaluated across three international codes.
    </div>
    <div class="terminal">
        <span class="output">[INFO] Loading design codes … 3 codes</span><br>
        <span class="output">[INFO] Loading pipeline data … 6 pipe sizes</span><br>
        <span class="output">[INFO] Evaluating pressure containment …</span><br>
        <span class="output">[INFO] Evaluating collapse resistance …</span><br>
        <span class="output">[INFO] Evaluating combined loading …</span><br>
        <span class="output">[INFO] Evaluating propagation buckling …</span><br><br>
        <div class="progress-row">
            <span class="output" style="min-width:100px">Cases:</span>
            <div class="progress-bar"><div class="progress-fill" style="width:100%"></div></div>
            <span class="success">72 / 72</span>
        </div>
        <div class="progress-row">
        ...
        <span class="success">✓ All 72 cases PASS</span>
        <span class="output"> — wall thickness within limits for all code/size/pressure combinations</span>
    </div>
    """
...
def scene_report_gen() -> str:
    ...
    <div class="terminal">
        ...
        <span class="highlight">&nbsp;&nbsp;examples/demos/gtm/output/demo_02_wall_thickness_report.html</span><br><br>
        <span class="success">✓</span>
        <span class="output"> JSON results cached:</span><br>
        <span class="highlight">&nbsp;&nbsp;examples/demos/gtm/results/demo_02_wall_thickness_results.json</span><br><br>
        <span class="output">Artifacts:</span><br>
        <span class="output">&nbsp;&nbsp;📊 Chart 1 — Wall Thickness by Pipe Size &amp; Code</span><br>
        <span class="output">&nbsp;&nbsp;📊 Chart 2 — Governing Check Distribution</span><br>
        <span class="output">&nbsp;&nbsp;📊 Chart 3 — Utilisation Ratio Heatmap</span><br>
        <span class="output">&nbsp;&nbsp;📊 Chart 4 — Pressure vs. Min WT</span><br>
        <span class="output">&nbsp;&nbsp;📊 Chart 5 — Code Comparison Overlay</span><br><br>
        <span class="prompt">agent $</span>
        <span class="cmd"> xdg-open examples/demos/gtm/output/demo_02_wall_thickness_report.html</span>
    </div>
    """
...
def scene_browser_label() -> str:
    ...
    <div class="subtitle">
        ...
        Interactive charts, summary tables, and full parameter matrix.
    </div>
    """
...
def capture_report_scroll(page) -> list[Image.Image]:
    """Load the real Demo 2 report and capture scroll-through frames."""
...
def main():
    if not REPORT_HTML.exists():
        raise FileNotFoundError(
            ...
            "Run Demo 2 first (or use --from-cache) to generate it."
        )
