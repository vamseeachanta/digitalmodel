...
"""Generate Demo 4 end-to-end workflow GIF.
...
the Demo 1 / Demo 2 / Demo 3 workflow GIF generators.
...
REPORT_HTML = SCRIPT_DIR.parent / "output" / "demo_04_shallow_pipelay_report.html"
OUTPUT_GIF = SCRIPT_DIR / "demo_04_shallow_pipelay_workflow.gif"
...
def scene_prompt() -> str:
    ...
    <div class="subtitle">
        The engineer describes the S-lay installation screening goal in plain English.<br>
        The agent resolves it to the correct demo and parameters.
    </div>
    <div class="terminal">
        <span class="prompt">user@ace-linux ~/digitalmodel $</span><br>
        <span class="comment"># Ask the AI agent for a shallow-water pipelay screening</span><br><br>
        <span class="accent">&#9654;</span>
        <span class="cmd"> "Run an S-lay catenary pipelay screening</span><br>
        <span class="cmd">&nbsp;&nbsp;for 2 vessels (Large PLV 600te, Shallow Water Barge 250te).</span><br>
        <span class="cmd">&nbsp;&nbsp;Cover 5 pipe sizes (8&#8243; to 24&#8243; X65) across 7–30 m depth.</span><br>
        <span class="cmd">&nbsp;&nbsp;Generate a Go/No-Go heatmap and tension charts."</span>
    </div>
    """
...
def scene_setup() -> str:
    ...
    <div class="subtitle">
        The agent maps the request to the Demo 4 script and resolves dependencies.
    </div>
    <div class="terminal">
        <span class="prompt">agent $</span>
        <span class="output"> Resolving analysis …</span><br>
        <span class="output">  → Script: </span>
        <span class="highlight">examples/demos/gtm/demo_04_shallow_water_pipelay.py</span><br>
        <span class="output">  → Vessels: Large PLV 600te · Shallow Water Barge 250te</span><br>
        <span class="output">  → Pipes:  8&#8243; · 12&#8243; · 16&#8243; · 20&#8243; · 24&#8243; (API X65)</span><br>
        <span class="output">  → Depths: 7 · 10 · 15 · 20 · 25 · 30 m</span><br>
        <span class="output">  → Cases:  </span>
        <span class="highlight">60</span>
        <span class="output"> (2 vessels × 5 pipes × 6 depths)</span><br><br>
        <span class="prompt">agent $</span>
        <span class="cmd"> PYTHONPATH=examples/demos/gtm:src \\</span><br>
        <span class="cmd">&nbsp;&nbsp;uv run python \\</span><br>
        <span class="cmd">&nbsp;&nbsp;examples/demos/gtm/demo_04_shallow_water_pipelay.py</span>
    </div>
    """
...
def scene_execution() -> str:
    ...
    <div class="title">S-Lay Catenary Screening Running</div>
    <div class="subtitle">
        60 cases evaluated — overbend stress, sagbend utilisation, and top tension.
    </div>
    <div class="terminal">
        <span class="output">[INFO] Loading vessel data … 2 vessels</span><br>
        <span class="output">[INFO] Loading pipeline data … 5 pipe sizes</span><br>
        <span class="output">[INFO] Computing catenary geometry …</span><br>
        <span class="output">[INFO] Evaluating overbend stress …</span><br>
        <span class="output">[INFO] Evaluating sagbend utilisation …</span><br>
        <span class="output">[INFO] Screening Go / Marginal / No-Go …</span><br><br>
        <div class="progress-row">
            <span class="output" style="min-width:100px">Cases:</span>
            <div class="progress-bar"><div class="progress-fill" style="width:100%"></div></div>
            <span class="success">60 / 60</span>
        </div>
        <div class="progress-row">
        ...
        <span class="success">✓ 60 cases screened</span>
        <span class="output"> — Go/No-Go assigned for all vessel × pipe × depth combinations</span>
    </div>
    """
...
def scene_report_gen() -> str:
    ...
    <div class="terminal">
        ...
        <span class="highlight">&nbsp;&nbsp;examples/demos/gtm/output/demo_04_shallow_pipelay_report.html</span><br><br>
        <span class="success">✓</span>
        <span class="output"> JSON results cached:</span><br>
        <span class="highlight">&nbsp;&nbsp;examples/demos/gtm/results/demo_04_shallow_pipelay_results.json</span><br><br>
        <span class="output">Artifacts:</span><br>
        <span class="output">&nbsp;&nbsp;📊 Chart 1 — Go/No-Go Heatmap (vessel × pipe × depth)</span><br>
        <span class="output">&nbsp;&nbsp;📊 Chart 2 — Sagbend Utilisation Heatmap</span><br>
        <span class="output">&nbsp;&nbsp;📊 Chart 3 — Top Tension vs Water Depth</span><br>
        <span class="output">&nbsp;&nbsp;📊 Chart 4 — Departure Angle by Vessel &amp; Pipe Size</span><br>
        <span class="output">&nbsp;&nbsp;📊 Chart 5 — Vessel Head-to-Head Comparison</span><br><br>
        <span class="prompt">agent $</span>
        <span class="cmd"> xdg-open examples/demos/gtm/output/demo_04_shallow_pipelay_report.html</span>
    </div>
    """
...
def scene_browser_label() -> str:
    ...
    <div class="subtitle">
        ...
        S-lay screening charts, Go/No-Go heatmap, and full parameter matrix.
    </div>
    """
...
def capture_report_scroll(page) -> list[Image.Image]:
    """Load the real Demo 4 report and capture scroll-through frames."""
...
def main():
    if not REPORT_HTML.exists():
        raise FileNotFoundError(
            ...
            "Run Demo 4 first (or use --from-cache) to generate it."
        )
