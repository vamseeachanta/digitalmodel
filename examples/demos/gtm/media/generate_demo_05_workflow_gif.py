...
"""Generate Demo 5 end-to-end workflow GIF.
...
the Demo 1–4 workflow GIF generators.

Usage:
    cd digitalmodel
    python3.12 examples/demos/gtm/media/generate_demo_05_workflow_gif.py
"""
...
REPORT_HTML = SCRIPT_DIR.parent / "output" / "demo_05_jumper_installation_report.html"
OUTPUT_GIF = SCRIPT_DIR / "demo_05_jumper_installation_workflow.gif"
...
def scene_prompt() -> str:
    ...
    <div class="subtitle">
        The engineer describes the deepwater rigid jumper installation screening goal in plain English.<br>
        The agent resolves it to the correct demo and parameters.
    </div>
    <div class="terminal">
        <span class="prompt">user@ace-linux ~/digitalmodel $</span><br>
        <span class="comment"># Ask the AI agent for a deepwater jumper installation screening</span><br><br>
        <span class="accent">&#9654;</span>
        <span class="cmd"> "Run a deepwater rigid jumper installation screening</span><br>
        <span class="cmd">&nbsp;&nbsp;for 2 CSV vessels (Large 5000te, Medium 2500te).</span><br>
        <span class="cmd">&nbsp;&nbsp;Cover 5 jumper lengths (20–100 m, 8&#8243; OD X65) across</span><br>
        <span class="cmd">&nbsp;&nbsp;500–3000 m depth with Hs 1.0–3.0 m.</span><br>
        <span class="cmd">&nbsp;&nbsp;Generate Go/No-Go matrix and operability envelopes."</span>
    </div>
    """
...
def scene_setup() -> str:
    ...
    <div class="subtitle">
        The agent maps the request to the Demo 5 script and resolves dependencies.
    </div>
    <div class="terminal">
        <span class="prompt">agent $</span>
        <span class="output"> Resolving analysis …</span><br>
        <span class="output">  → Script: </span>
        <span class="highlight">examples/demos/gtm/demo_05_deepwater_rigid_jumper_installation.py</span><br>
        <span class="output">  → Vessels: Large CSV 5000te · Medium CSV 2500te</span><br>
        <span class="output">  → Jumpers: 20 · 40 · 60 · 80 · 100 m (8&#8243; OD X65)</span><br>
        <span class="output">  → Depths:  500 · 1000 · 1500 · 2000 · 2500 · 3000 m</span><br>
        <span class="output">  → Hs:     1.0 · 1.5 · 2.0 · 2.5 · 3.0 m</span><br>
        <span class="output">  → Cases:  </span>
        <span class="highlight">300</span>
        <span class="output"> (2 vessels × 5 jumpers × 6 depths × 5 Hs)</span><br><br>
        <span class="prompt">agent $</span>
        <span class="cmd"> PYTHONPATH=examples/demos/gtm:src \\</span><br>
        <span class="cmd">&nbsp;&nbsp;uv run python \\</span><br>
        <span class="cmd">&nbsp;&nbsp;examples/demos/gtm/demo_05_deepwater_rigid_jumper_installation.py</span>
    </div>
    """
...
def scene_execution() -> str:
    ...
    <div class="title">Deepwater Jumper Installation Screening Running</div>
    <div class="subtitle">
        300 cases evaluated — 5 installation phases per case: lift-off, in-air bending,<br>
        splash zone, lowering, and tie-in alignment.
    </div>
    <div class="terminal">
        <span class="output">[INFO] Loading vessel data … 2 CSV vessels</span><br>
        <span class="output">[INFO] Loading jumper matrix … 5 lengths × 8&#8243; OD X65</span><br>
        <span class="output">[INFO] Evaluating lift-off hook loads …</span><br>
        <span class="output">[INFO] Evaluating in-air bending stress …</span><br>
        <span class="output">[INFO] Evaluating splash zone slamming + drag …</span><br>
        <span class="output">[INFO] Evaluating lowering cable tension …</span><br>
        <span class="output">[INFO] Evaluating tie-in alignment deflection …</span><br><br>
        <div class="progress-row">
            <span class="output" style="min-width:100px">Cases:</span>
            <div class="progress-bar"><div class="progress-fill" style="width:100%"></div></div>
            <span class="success">300 / 300</span>
        </div>
        <div class="progress-row">
        ...
        <span class="success">✓ 300 cases screened</span>
        <span class="output"> — Go/No-Go assigned across all vessel × jumper × depth × Hs combinations</span>
    </div>
    """
...
def scene_report_gen() -> str:
    ...
    <div class="terminal">
        ...
        <span class="highlight">&nbsp;&nbsp;examples/demos/gtm/output/demo_05_jumper_installation_report.html</span><br><br>
        <span class="success">✓</span>
        <span class="output"> JSON results cached:</span><br>
        <span class="highlight">&nbsp;&nbsp;examples/demos/gtm/results/demo_05_jumper_installation_results.json</span><br><br>
        <span class="output">Artifacts:</span><br>
        <span class="output">&nbsp;&nbsp;📊 Chart 1 — Go/No-Go Installation Matrix</span><br>
        <span class="output">&nbsp;&nbsp;📊 Chart 2 — In-Air Bending Stress vs Jumper Length</span><br>
        <span class="output">&nbsp;&nbsp;📊 Chart 3 — Operability Envelope (Max Allowable Hs)</span><br>
        <span class="output">&nbsp;&nbsp;📊 Chart 4 — Cable Tension vs Water Depth</span><br>
        <span class="output">&nbsp;&nbsp;📊 Chart 5 — Vessel Comparison (Max Installable Jumper)</span><br><br>
        <span class="prompt">agent $</span>
        <span class="cmd"> xdg-open examples/demos/gtm/output/demo_05_jumper_installation_report.html</span>
    </div>
    """
...
def scene_browser_label() -> str:
    ...
    <div class="subtitle">
        ...
        Installation Go/No-Go matrix, operability envelopes, and cable tension charts.
    </div>
    """
...
def capture_report_scroll(page) -> list[Image.Image]:
    """Load the real Demo 5 report and capture scroll-through frames."""
...
def main():
    if not REPORT_HTML.exists():
        raise FileNotFoundError(
            ...
            "Run Demo 5 first (or use --from-cache) to generate it."
        )
