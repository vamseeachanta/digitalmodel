...
python scripts/generate_calm_buoy_project.py \
  --config D:\workspace-hub\digitalmodel\projects\NSE_CALM_001/project_config.yml \
  --regenerate
```
...
python run_validation.py \
  --files D:\workspace-hub\digitalmodel\projects\NSE_CALM_001/orcaflex/NSE_CALM_001_calm_buoy.yml
```
