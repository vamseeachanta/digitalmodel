...
class TestCSVToLibraryConversion:
    ...
    def test_line_type_from_csv_row(self):
        ...
        from digitalmodel.solvers.orcaflex.library_generator import csv_row_to_line_type
    ...
    def test_buoy_type_from_csv_row(self):
        ...
        from digitalmodel.solvers.orcaflex.library_generator import csv_row_to_buoy_type
