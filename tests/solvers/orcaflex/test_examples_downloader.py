...
class TestOrcaflexExampleDownloader(unittest.TestCase):
    ...
    @patch('digitalmodel.solvers.orcaflex.examples_integration.downloader.requests.Session')
    ...
    @patch('digitalmodel.solvers.orcaflex.examples_integration.downloader.requests.Session.get')
    ...
    @patch('digitalmodel.solvers.orcaflex.examples_integration.downloader.OrcaflexExampleDownloader._download_with_retry')
