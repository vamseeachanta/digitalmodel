...
class TestSchemaImports:
    ...
    def test_import_metadata(self):
        from digitalmodel.solvers.orcaflex.modular_generator.schema import Metadata
    ...
    def test_import_simulation(self):
        from digitalmodel.solvers.orcaflex.modular_generator.schema import Simulation
...
class TestSchemaValidation:
    ...
    def test_invalid_wall_thickness(self):
        ...
        from digitalmodel.solvers.orcaflex.modular_generator.schema import Dimensions
    ...
    def test_invalid_current_profile_not_monotonic(self):
        ...
        from digitalmodel.solvers.orcaflex.modular_generator.schema import Current
