...
class TestCatenaryRiserSummary:
    ...
    @patch('digitalmodel.subsea.catenary_riser.legacy.catenary_riser_summary.plt')
    ...
    @patch('digitalmodel.subsea.catenary_riser.legacy.catenary_riser_summary.application_configuration')
    ...
    @patch('digitalmodel.subsea.catenary_riser.legacy.catenary_riser_summary.CompareTools')
    ...
    def test_basename_extraction(self):
        ...
        with patch('digitalmodel.subsea.catenary_riser.legacy.catenary_riser_summary.os.path.basename') as mock_basename:
    ...
    @patch('digitalmodel.subsea.catenary_riser.legacy.catenary_riser_summary.logging')
    ...
    def test_source_code_analysis(self):
        ...
        assert 'basename = os.path.basename(__file__)' in content  # Part of the line
        ...
        # Verify line count is reasonable (117-120 lines expected)
        lines = content.split('\n')
        assert 115 <= len(lines) <= 125, f"Line count {len(lines)} outside expected range"
