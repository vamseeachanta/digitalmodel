...
class TestSimpleCommand:
    ...
    @patch('digitalmodel.catenary_riser.cli.SimpleCatenaryAnalyzer')
    @patch('digitalmodel.catenary_riser.cli.get_material')
    @patch('digitalmodel.catenary_riser.cli.get_fluid')
...
class TestWeightCommand:
    ...
    @patch('digitalmodel.catenary_riser.cli.EffectiveWeightCalculator')
    @patch('digitalmodel.catenary_riser.cli.get_material')
    @patch('digitalmodel.catenary_riser.cli.get_fluid')
...
class TestLazyWaveCommand:
    ...
    @patch('digitalmodel.catenary_riser.cli.LazyWaveAnalyzer')
    @patch('digitalmodel.catenary_riser.cli.get_material')
    @patch('digitalmodel.catenary_riser.cli.get_fluid')
