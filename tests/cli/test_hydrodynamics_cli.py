...
class TestSpectrumCommand:
    ...
    @patch('digitalmodel.modules.hydrodynamics.cli.WaveSpectra')
...
class TestOCIMFWindCommand:
    ...
    @patch('digitalmodel.modules.hydrodynamics.cli.OCIMFLoading')
    @patch('digitalmodel.modules.hydrodynamics.cli.get_vessel_type')
