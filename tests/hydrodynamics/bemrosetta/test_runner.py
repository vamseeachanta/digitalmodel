...
class TestBEMRosettaRunner:
    ...
    def test_initialization_without_path(self):
        ...
        from digitalmodel.hydrodynamics.bemrosetta.core.runner import BEMRosettaRunner
    ...
    def test_run_raises_when_not_available(self, mock_run):
        ...
        from digitalmodel.hydrodynamics.bemrosetta.core.runner import BEMRosettaRunner
        from digitalmodel.hydrodynamics.bemrosetta.core.exceptions import ExecutableNotFoundError
...
class TestGetRunner:
    ...
    def test_returns_bemrosetta_runner(self):
        ...
        from digitalmodel.hydrodynamics.bemrosetta.core.runner import (
            get_runner,
            BEMRosettaRunner,
        )

        # Reset singleton for testing
        import digitalmodel.hydrodynamics.bemrosetta.core.runner as runner_module
    ...
    def test_returns_same_instance(self):
        ...
        from digitalmodel.hydrodynamics.bemrosetta.core.runner import get_runner
...
class TestIsBemRosettaAvailable:
    ...
    def test_returns_bool(self):
        ...
        from digitalmodel.hydrodynamics.bemrosetta.core.runner import is_bemrosetta_available
    ...
    def test_calls_runner_is_available(self):
        ...
        from digitalmodel.hydrodynamics.bemrosetta.core import runner as runner_module
