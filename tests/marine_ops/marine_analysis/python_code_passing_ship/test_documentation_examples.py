...
def test_cli_module_entry():
    ...
    try:
        ...
        result = subprocess.run(
            [sys.executable, '-m', 'digitalmodel.marine_ops.marine_analysis.python_code_passing_ship', '--help'],
            capture_output=True,
            text=True
        )
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            result = subprocess.run(
                [sys.executable, '-m', 'digitalmodel.marine_ops.marine_analysis.python_code_passing_ship',
                 '--config', config_path,
...
def test_configuration_examples():
    ...
    from digitalmodel.marine_ops.marine_analysis.python_code_passing_ship.configuration import ShipConfiguration
