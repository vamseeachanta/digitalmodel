...
1. ✅ **Pattern A (RECOMMENDED):** `from digitalmodel.marine_analysis import X`
...
|------------|------------|----------------|
| `from marine_engineering.catenary import` | `from digitalmodel.marine_analysis import` | 5 files |
| `from src.marine_engineering.catenary import` | `from digitalmodel.marine_analysis import` | 3 files |
| `from marine_engineering.environmental_loading import` | `from digitalmodel.marine_analysis import` | 6 files |
...
**Issue:** Some modules (wave_spectra, hydrodynamic_coefficients) don't exist in `digitalmodel.marine_analysis`
...
# AFTER:
from digitalmodel.marine_analysis.catenary import (
    CatenarySolver, CatenaryInput, CatenaryResults,
    catenaryEquation, catenaryForces,
...
**Note:** Verify `catenary` module is exported in `digitalmodel.marine_analysis.__init__.py`
...
1. **digitalmodel.marine_analysis.__init__.py**
...
- [ ] Fix `run_extraction.py:18` import error
  ...
  - [ ] Test: `python -c "from digitalmodel.marine_analysis import UnifiedRAOReader"`

- [ ] Fix RAOPlotter import path
  - [ ] Update `__init__.py:45` to use `from .visualization.rao_plotter import RAOPlotter`
  - [ ] Test: `python -c "from digitalmodel.marine_analysis import RAOPlotter; print(RAOPlotter)"`
...
- [ ] Update __all__ exports
  - [ ] digitalmodel.marine_analysis.__init__.py
...
### Must Have (Phase 1)
- [ ] No import errors when importing `digitalmodel.marine_analysis`
