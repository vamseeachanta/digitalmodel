...
1. ❌ **Extraction module import error** - Blocks `digitalmodel.marine_ops.marine_analysis` imports
...
python -c "from digitalmodel.marine_ops.marine_analysis import RAOPlotter; print('✅ Success')"
...
**Cause:** Tests may depend on modules not in `digitalmodel.marine_ops.marine_analysis`
