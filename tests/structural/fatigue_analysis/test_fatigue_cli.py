...
from digitalmodel.structural.fatigue_apps.__main__ import (
    parse_arguments,
    validate_inputs,
    setup_logging,
    run_analysis
...
class TestInputValidation:
    ...
    def test_valid_inputs(self, tmp_path):
        ...
        with patch('digitalmodel.structural.fatigue_apps.__main__.logging') as mock_logging:
...
class TestEndToEnd:
    ...
    def test_complete_cli_flow(self, tmp_path, monkeypatch):
        ...
        with patch('sys.argv', test_args):
            ...
            with patch('digitalmodel.structural.fatigue_apps.__main__.run_analysis') as mock_run:
                mock_run.return_value = True
                
                # Import and run main
                from digitalmodel.structural.fatigue_apps.__main__ import main
