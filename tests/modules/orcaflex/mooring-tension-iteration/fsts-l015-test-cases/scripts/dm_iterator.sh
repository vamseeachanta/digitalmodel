...
/d/github/digitalmodel/.venv/Scripts/python -m digitalmodel viz.yml "{'meta': {'label': 'viz_fsts_'}, 'file_management': {'input_directory': '../.sim/', 'output_directory': '../output/visual', 'filename': {'pattern': 'fsts_*_vessel_statics_6dof'}}}" --workers 30
