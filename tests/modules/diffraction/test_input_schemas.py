...
class TestDiffractionSpecValidation:
    ...
    def test_negative_water_depth_raises(self):
        ...
        from digitalmodel.diffraction.input_schemas import EnvironmentSpec
        with pytest.raises(Exception):
    ...
    def test_missing_mass_raises(self):
        ...
        from digitalmodel.diffraction.input_schemas import VesselInertia
        with pytest.raises(Exception):
...
class TestFrequencySpec:
    ...
    def test_explicit_frequency_values(self):
        ...
        from digitalmodel.diffraction.input_schemas import FrequencySpec
...
class TestWaveHeadingSpec:
    ...
    def test_explicit_heading_values(self):
        ...
        from digitalmodel.diffraction.input_schemas import WaveHeadingSpec
