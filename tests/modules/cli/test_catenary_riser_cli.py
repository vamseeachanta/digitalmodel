...
class TestSimpleCommand:
    ...
    @patch('digitalmodel.modules.catenary_riser.cli.SimpleCatenaryAnalyzer')
    @patch('digitalmodel.modules.catenary_riser.cli.get_material')
    @patch('digitalmodel.modules.catenary_riser.cli.get_fluid')
...
class TestWeightCommand:
    ...
    @patch('digitalmodel.modules.catenary_riser.cli.EffectiveWeightCalculator')
    @patch('digitalmodel.modules.catenary_riser.cli.get_material')
    @patch('digitalmodel.modules.catenary_riser.cli.get_fluid')
...
class TestLazyWaveCommand:
    ...
    @patch('digitalmodel.modules.catenary_riser.cli.LazyWaveAnalyzer')
    @patch('digitalmodel.modules.catenary_riser.cli.get_material')
    @patch('digitalmodel.modules.catenary_riser.cli.get_fluid')
