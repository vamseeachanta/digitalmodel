...
from digitalmodel.specialized.digitalmarketing.seo.seo_analysis import SEOAnalysis
...
class TestSEOAnalysis:
    ...
    @patch('digitalmodel.specialized.digitalmarketing.seo.seo_analysis.seolib')
