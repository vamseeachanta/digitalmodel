...
def run_ship_design(input_file, expected_result={}):
    with patch('digitalmodel.engine.engine') as mock_engine:
        mock_engine.return_value = {'status': 'completed', 'basename': 'seasam_combined_fatigue', 'fatigue_analysis': {'combined': {}, 'damage': {}}}
...
def test_ship_design():
    input_file = '../test_data/ship_design/ship_design_seasam_combined_fatigue.yml'
