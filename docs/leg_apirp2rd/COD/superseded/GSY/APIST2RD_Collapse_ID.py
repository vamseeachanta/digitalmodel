...
def APISTD2RDCalculation(APISTD2RD):
    ...
    YieldCollapsePressure_1= 2*APISTD2RD.SMYS*(APISTD2RD.NominalWT_1/APISTD2RD.NominalID_1)
    YieldCollapsePressure_2= 2*APISTD2RD.SMYS*(APISTD2RD.NominalWT_2/APISTD2RD.NominalID_1)
    YieldCollapsePressure_3= 2*APISTD2RD.SMYS*(APISTD2RD.NominalWT_3/APISTD2RD.NominalID_1)
    YieldCollapsePressure_4= 2*APISTD2RD.SMYS*(APISTD2RD.NominalWT_4/APISTD2RD.NominalID_1)
    YieldCollapsePressure_5= 2*APISTD2RD.SMYS*(APISTD2RD.NominalWT_5/APISTD2RD.NominalID_1)
    YieldCollapsePressure_6= 2*APISTD2RD.SMYS*(APISTD2RD.NominalWT_6/APISTD2RD.NominalID_1)
    YieldCollapsePressure_7= 2*APISTD2RD.SMYS*(APISTD2RD.NominalWT_7/APISTD2RD.NominalID_1)
   
    #print("YieldCollapsePressure : ","{0:.2f}".format(YieldCollapsePressure))

    #elastic collapse pressure Pel
    ElasticCollapsePressure_1= 2*APISTD2RD.E*(APISTD2RD.NominalWT_1/APISTD2RD.NominalID_1)**3/(1-APISTD2RD.Poissionsratio**2)
    ElasticCollapsePressure_2= 2*APISTD2RD.E*(APISTD2RD.NominalWT_2/APISTD2RD.NominalID_1)**3/(1-APISTD2RD.Poissionsratio**2)
    ElasticCollapsePressure_3= 2*APISTD2RD.E*(APISTD2RD.NominalWT_3/APISTD2RD.NominalID_1)**3/(1-APISTD2RD.Poissionsratio**2)
    ElasticCollapsePressure_4= 2*APISTD2RD.E*(APISTD2RD.NominalWT_4/APISTD2RD.NominalID_1)**3/(1-APISTD2RD.Poissionsratio**2)
    ElasticCollapsePressure_5= 2*APISTD2RD.E*(APISTD2RD.NominalWT_5/APISTD2RD.NominalID_1)**3/(1-APISTD2RD.Poissionsratio**2)
    ElasticCollapsePressure_6= 2*APISTD2RD.E*(APISTD2RD.NominalWT_6/APISTD2RD.NominalID_1)**3/(1-APISTD2RD.Poissionsratio**2)
    ElasticCollapsePressure_7= 2*APISTD2RD.E*(APISTD2RD.NominalWT_7/APISTD2RD.NominalID_1)**3/(1-APISTD2RD.Poissionsratio**2)
    
    #print("ElasticCollapsePressure : ","{0:.2f}".format(ElasticCollapsePressure))
   
    #plastic collapse pressure Pp

    PlasticCollapsePressure_1=2*APISTD2RD.NominalWT_1/APISTD2RD.NominalID_1*APISTD2RD.SMYS*APISTD2RD.alphafab
    PlasticCollapsePressure_2=2*APISTD2RD.NominalWT_2/APISTD2RD.NominalID_1*APISTD2RD.SMYS*APISTD2RD.alphafab
    PlasticCollapsePressure_3=2*APISTD2RD.NominalWT_3/APISTD2RD.NominalID_1*APISTD2RD.SMYS*APISTD2RD.alphafab
    PlasticCollapsePressure_4=2*APISTD2RD.NominalWT_4/APISTD2RD.NominalID_1*APISTD2RD.SMYS*APISTD2RD.alphafab
    PlasticCollapsePressure_5=2*APISTD2RD.NominalWT_5/APISTD2RD.NominalID_1*APISTD2RD.SMYS*APISTD2RD.alphafab
    PlasticCollapsePressure_6=2*APISTD2RD.NominalWT_6/APISTD2RD.NominalID_1*APISTD2RD.SMYS*APISTD2RD.alphafab
    PlasticCollapsePressure_7=2*APISTD2RD.NominalWT_7/APISTD2RD.NominalID_1*APISTD2RD.SMYS*APISTD2RD.alphafab
    ...
    RHS=CollapsePressure_1*ElasticCollapsePressure_1*PlasticCollapsePressure_1*2*APISTD2RD.ovality*(APISTD2RD.NominalID_1/APISTD2RD.NominalWT_1)
    ...
    y_axis2 = [578.44,781.94,1030.42,1307.33,1617.34,1968.02,2332.45]
    

    
    #it creates plot tittle, color and size
    plt.suptitle('CollapsePressureWithThickness', fontsize=14,color='black')
    plt.title('InnerDiameter=12 Inch, Design_FactorFD=0.70, APISTD2RD', fontsize=12, color='blue')
    ...
    plt.savefig("CollapsePressureWithThickness_US_ID.png",dpi=800)
