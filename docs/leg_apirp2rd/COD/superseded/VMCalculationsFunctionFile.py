...
def VMStress(**pipe1):
    ...
    internalPressureLimit = DesignCaseFac*pipe1['pipeYieldStrength']*math.sqrt(2)/ math.sqrt( (pipeNominalID/(pipeNominalID + pipe1['pipeNominalOD_m']))**2 +
                                                                                              (pipe1['pipeNominalOD_m']/2/pipe1['pipeNominalWT_m'])**2 +
                                                                                              ((pipeNominalID/(pipeNominalID + pipe1['pipeNominalOD_m']))-
                                                                                                (pipe1['pipeNominalOD_m']/2/pipe1['pipeNominalWT_m']) )**2 )
