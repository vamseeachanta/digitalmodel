...
def VMStress():
    ...
    from VMStressCalculations_R13 import pipe1, pipe2,pipe3,pipe4,pipe5,pipe6,pipe7,pipe8
...
##        print("Tension_"+str(count)+" : ","{:.2f}".format(Tension1*1E-3)," kN ")
        TensionList1.append((Tension_positive1/1000)/4.448)
        TensionList2.append((Tension_negative1/1000)/4.448)
    ...
    pyplot.savefig("Tension vs Moment2.png",dpi=800)
    pyplot.show()
    #Tension R.H.S
