...
The criteria are a documentation surface, not a new executable module; the module routing registry remains unchanged. The existing documentation-routing tests remain applicable to their original contracts and do not establish criteria adoption.
