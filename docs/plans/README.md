...
|---|---|---|---|---|---|---|
| [#1602](https://github.com/vamseeachanta/digitalmodel/issues/1602) | riser-data-orcaflex-hf-program | `docs/plans/2026-07-16-issue-1602-riser-data-orcaflex-hf-plan.md` | 2026-07-16 | draft | T3 | Owner approved the parent/child contract-depth refactor. Round 12 returned two approvals and one request-authentication MAJOR. Interface v2 draft 8 requires the requester signature to authenticate a commitment covering every non-self-referential request binding; round 13 pending. |
