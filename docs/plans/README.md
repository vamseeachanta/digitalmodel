...
|---|---|---|---|---|---|---|
| [#1602](https://github.com/vamseeachanta/digitalmodel/issues/1602) | riser-data-orcaflex-hf-program | `docs/plans/2026-07-16-issue-1602-riser-data-orcaflex-hf-plan.md` | 2026-07-16 | draft | T3 | Owner approved the parent/child contract-depth refactor. Round 7 returned MAJOR on remaining joins. Interface v2 draft 3 adds consumer/hash propagation, separates logical release from HF publication receipt, binds website/closeout freshness, and uses #1602-scoped milestones; round 8 pending. |
