...
|---|---|---|---|---|---|---|
| [#1602](https://github.com/vamseeachanta/digitalmodel/issues/1602) | riser-data-orcaflex-hf-program | `docs/plans/2026-07-16-issue-1602-riser-data-orcaflex-hf-plan.md` | 2026-07-16 | draft | T3 | Owner approved the parent/child contract-depth refactor. Round 13 returned two approvals and one validator-hardening MAJOR. Interface v2 draft 9 pins the parent-owned request/receipt minimum-binding sets before commitment/authentication validation; round 14 pending. |
