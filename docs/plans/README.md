...
|---|---|---|---|---|---|---|
| [#1602](https://github.com/vamseeachanta/digitalmodel/issues/1602) | riser-data-orcaflex-hf-program | `docs/plans/2026-07-16-issue-1602-riser-data-orcaflex-hf-plan.md` | 2026-07-16 | draft | T3 | Owner approved the parent/child contract-depth refactor. Round 8 found incomplete repeated-identity equalities. Interface v2 draft 4 adds a complete mandatory handoff/derivation matrix, result-set commitment, rendered-release binding, and hard validator baseline; round 9 pending. |
