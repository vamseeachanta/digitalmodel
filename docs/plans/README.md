...
|---|---|---|---|---|---|---|
| [#1602](https://github.com/vamseeachanta/digitalmodel/issues/1602) | riser-data-orcaflex-hf-program | `docs/plans/2026-07-16-issue-1602-riser-data-orcaflex-hf-plan.md` | 2026-07-16 | draft | T3 | Owner approved the parent/child contract-depth refactor after five MAJOR rounds. Parent interface v2 retains architecture, coordinates, identity chain, 13 public surfaces, ownership and fail-closed gates; exact executable contracts move to child owners. Round 6 is pending. |
