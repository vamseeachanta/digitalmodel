...
|---|---|---|---|---|---|---|
| [#1602](https://github.com/vamseeachanta/digitalmodel/issues/1602) | riser-data-orcaflex-hf-program | `docs/plans/2026-07-16-issue-1602-riser-data-orcaflex-hf-plan.md` | 2026-07-16 | draft | T3 | Owner approved the parent/child contract-depth refactor. Round 6 returned MAJOR on trust direction and lifecycle/DAG evidence. Interface v2 draft 2 separates requester/executor and pre/post-run analysis, binds family requests/model/oracle/security evidence, and validates the acyclic DAG; round 7 pending. |
