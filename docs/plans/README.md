...
|---|---|---|---|---|---|---|
| [#1602](https://github.com/vamseeachanta/digitalmodel/issues/1602) | solver-neutral-riser-data-orcaflex-v1-hf-program | `docs/plans/2026-07-16-issue-1602-riser-data-orcaflex-hf-plan.md` | 2026-07-17 | draft | T3 | Owner directed a generic solver-neutral SSOT supporting replaceable solver adapters. Interface v2 draft 11 keeps OrcaFlex as v1, binds target semantic coverage/gap evidence as a pre-execution terminal gate, and prohibits every native solver model format from HF; Round 16 pending. |
