...
|---|---|---|---|---|---|---|
| [#1602](https://github.com/vamseeachanta/digitalmodel/issues/1602) | riser-data-orcaflex-hf-program | `docs/plans/2026-07-16-issue-1602-riser-data-orcaflex-hf-plan.md` | 2026-07-16 | draft | T3 | Owner approved the parent/child contract-depth refactor. Round 11 found two narrow validator/receipt-coverage gaps. Interface v2 draft 7 expands every selected-request route in validation and requires the authenticated receipt to commit every binding; round 12 pending. |
