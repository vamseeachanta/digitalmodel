...
|---|---|---|---|---|---|---|
| [#1602](https://github.com/vamseeachanta/digitalmodel/issues/1602) | riser-data-orcaflex-hf-program | `docs/plans/2026-07-16-issue-1602-riser-data-orcaflex-hf-plan.md` | 2026-07-16 | draft | T3 | Owner-approved Option 1 design. Initial provider fanout was unavailable; three fallback reviews returned MAJOR. Draft 2 adds the normative cross-layer contract and awaits fresh no-MAJOR review. |
