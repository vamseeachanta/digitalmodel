...
### File Locations
- **API Script**: `/docs/domains/orcawave/examples/L01_default_vessel/run_orcawave_diffraction.py`
- **Simple Test Config**: `/docs/domains/orcawave/examples/L01_default_vessel/L01_license_test.yml`
- **Benchmark Config**: `/docs/domains/orcawave/L01_aqwa_benchmark/orcawave_001_ship_raos_rev2.yml`
