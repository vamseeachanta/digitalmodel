...
- **Execution scripts**:
  - `docs/domains/orcawave/L01_aqwa_benchmark/run_orcawave_shell.py`
  - `docs/domains/orcawave/L01_aqwa_benchmark/run_orcawave_benchmark.py`
  - `docs/domains/orcawave/L01_aqwa_benchmark/run_orcawave.sh`
- **Documentation**:
