...
> Location: `docs/domains/openscad/simple/` and `docs/domains/freecad/simple/`
...
**OpenSCAD Files** (`docs/domains/openscad/simple/`):
...
**FreeCAD Files** (`docs/domains/freecad/simple/`):
