...
class TestModuleRouting:
    ...
    def test_vertical_riser_function_call(self, standard_mocks):
        ...
        with patch('digitalmodel.subsea.vertical_riser.vertical_riser.vertical_riser') as mock_func:
    ...
    @pytest.mark.parametrize("basename,module_path,class_name", [
        ...
        ("rao_analysis", "digitalmodel.hydrodynamics.rao_analysis.rao_analysis.RAOAnalysis", "RAOAnalysis"),
        ("ship_design", "digitalmodel.common.ship_design.ShipDesign", "ShipDesign"),
        ("fatigue_analysis", "digitalmodel.signal_processing.signal_analysis.fatigue.FatigueDamageCalculator", "FatigueAnalysis"),
        ("cathodic_protection", "digitalmodel.common.cathodic_protection.CathodicProtection", "CathodicProtection"),
        ("transformation", "digitalmodel.infrastructure.transformation.transformation.Transformation", "Transformation"),
        ("pipeline", "digitalmodel.subsea.pipeline.pipeline.Pipeline", "Pipeline"),
        ("pipe_capacity", "digitalmodel.structural.pipe_capacity.pipe_capacity.PipeCapacity", "PipeCapacity"),
        ("viv_analysis", "digitalmodel.subsea.viv_analysis.viv_analysis.VIVAnalysis", "VIVAnalysis"),
        ("time_series", "digitalmodel.signal_processing.time_series.time_series_analysis.TimeSeriesAnalysis", "TimeSeriesAnalysis"),
        ("plate_buckling", "digitalmodel.common.plate_buckling.PlateBuckling", "PlateBuckling"),
        ("mooring", "digitalmodel.subsea.mooring_analysis.mooring.Mooring", "Mooring"),
    ])
...
class TestEngineIntegration:
    ...
    def test_end_to_end_workflow(self, tmp_path):
        ...
        with patch('digitalmodel.signal_processing.time_series.time_series_analysis.TimeSeriesAnalysis') as mock_tsa:
            mock_instance = Mock()
...
class TestEngineProperties:
    ...
    def test_engine_handles_arbitrary_valid_configs(self, basename, extra_fields):
        ...
        module_mocks = {
            ...
            'catenary': 'digitalmodel.subsea.catenary.catenary.Catenary',
            'aqwa': 'digitalmodel.aqwa.Aqwa',
            # ... add other mappings as needed
        }

        mock_path = module_mocks.get(basename, 'digitalmodel.infrastructure.generic.Generic')
