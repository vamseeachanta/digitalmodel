...
python docs/domains/diffraction/examples/complete_conversion_example.py
```
...
vessel.VesselType = 'docs/domains/diffraction/examples/outputs/Example_FPSO_vessel_type.yml'
...
# Load RAO data
raos_df = pd.read_csv('docs/domains/diffraction/examples/outputs/Example_FPSO_raos.csv')

# Load added mass matrices
am_df = pd.read_csv('docs/domains/diffraction/examples/outputs/Example_FPSO_added_mass.csv')

# Load damping matrices
damp_df = pd.read_csv('docs/domains/diffraction/examples/outputs/Example_FPSO_damping.csv')
```
...
```
docs/domains/diffraction/examples/
├── README.md                           # This file
...
- **Phase 2 Completion Report**: `docs/domains/diffraction/PHASE_2_COMPLETION.md`
- **Diffraction Module README**: `docs/domains/diffraction/README.md`
- **AQWA Quick Start**: `docs/domains/aqwa/QUICK_START.md`
- **Expansion Plan**: `docs/domains/orcawave/DIFFRACTION_CAPABILITIES_EXPANSION_PLAN.md`
