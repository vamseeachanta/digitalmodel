...
echo "3. Read documentation: docs/domains/agent-os/enhanced-create-specs-user-guide.md"
EOF
...
1. **Read the User Guide**: `docs/domains/agent-os/enhanced-create-specs-user-guide.md`
