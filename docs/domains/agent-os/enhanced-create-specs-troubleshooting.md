...
1. **Migration Guide**: @docs/domains/agent-os/enhanced-create-specs-migration-guide.md
2. **User Guide**: @docs/domains/agent-os/enhanced-create-specs-user-guide.md
