...
**Location**: `docs/domains/orcaflex/templates/components/`
...
**Location**: `docs/domains/orcaflex/templates/`
...
2. **Quick Start Guide** (`docs/domains/orcaflex/QUICKSTART_MODEL_GENERATOR.md`)
   - 5-minute tutorial
   - Common tasks
...
3. **Usage Examples** (`docs/domains/orcaflex/examples/model_generator_examples.py`)
...
13. `docs/domains/orcaflex/templates/README.md` (~480 lines)
14. `docs/domains/orcaflex/templates/risers/scr_catenary/README.md` (~400 lines)
15. `docs/domains/orcaflex/templates/risers/scr_catenary/config_template.yml`
16. `docs/domains/orcaflex/templates/risers/scr_catenary/example_basic.yml`
17. `docs/domains/orcaflex/templates/risers/scr_catenary/example_advanced.yml`
18. `docs/domains/orcaflex/templates/risers/scr_catenary/model_template.yml`

### Documentation (3 files)
19. `docs/domains/orcaflex/QUICKSTART_MODEL_GENERATOR.md` (~300 lines)
20. `docs/domains/orcaflex/examples/model_generator_examples.py` (~400 lines)
