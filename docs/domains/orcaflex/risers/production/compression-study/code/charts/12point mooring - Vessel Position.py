...
pyplot.title('12Point Mooring - Vessel Position', fontsize=14, fontweight='bold', color='black')
...
pyplot.yticks(range(-10, 70, 10))    
#It defines range of X axis 
pyplot.xticks(range(-10, 70, 10))
#It write text on plot in static point
pyplot.text(-6, -6, r'Static')
#It write text on plot in Wind point
pyplot.text(32, 22, r'Wind')
#It write text on plot in Current point
pyplot.text(25, 32, r'Current')
#It write text on plot in All point
pyplot.text(42.5, 47, r'100 yr Hurricane')
#It save the plot with 1200 pixel
pyplot.savefig("VesselPosition_12Point.png",dpi=1200)
