...
def example_1_single_dat_to_yml():
    ...
    # Convert file
    input_file = Path("docs/domains/orcaflex/examples/raw/A01/braceline.dat")
...
def example_2_yml_to_dat():
    ...
    dat_file = Path("docs/domains/orcaflex/examples/raw/A01/braceline.dat")
...
def example_4_parallel_processing():
    ...
    converter = OrcaFlexConverterEnhanced(
        input_dir=input_dir,
        output_dir=Path("docs/domains/orcaflex/examples/yaml_parallel"),
        output_format='yml',
...
def example_5_round_trip_validation():
    ...
    original_dat = Path("docs/domains/orcaflex/examples/raw/A01/braceline.dat")
