...
1. **Try the examples**: Run `docs/domains/orcaflex/examples/model_generator_examples.py`
...
4. **Explore templates**: Browse `docs/domains/orcaflex/templates/`

---

## Getting Help

- **Documentation**: `docs/domains/orcaflex/templates/README.md`
