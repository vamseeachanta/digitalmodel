...
Location: `docs/domains/orcaflex/templates/risers/scr_catenary/`
...
### Documentation
- `docs/domains/orcaflex/QUICKSTART_MODEL_GENERATOR.md`
- `docs/domains/orcaflex/universal_runner_guide.md`
- `docs/domains/orcaflex/HUMAN_FRIENDLY_YAML_FORMAT.md`

### Templates
- `docs/domains/orcaflex/templates/components/` (component libraries)
- `docs/domains/orcaflex/templates/risers/scr_catenary/` (SCR template)

### Examples (440 .yml files)
- `docs/domains/orcaflex/examples/raw/` (original examples)
- `docs/domains/orcaflex/examples/gom_scr_design_study/` (design study)
- `docs/domains/orcaflex/mooring/buoy/` (mooring examples)
...
1. **Use templates** from `docs/domains/orcaflex/templates/` as starting points
