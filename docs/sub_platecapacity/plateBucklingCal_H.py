...
ηsx_simp=σH_xx/σscrx_simp
FALSE=σH_yy/σscry_simp
ηsz_simp=τ_H/σscrz_simp
...
ηux_simp=σH_xx/σucrx_simp1
ηuy_simp=σH_yy/σucry_simp2
ηuz_simp=τ_H/σucrz_simp1
...
ηsx_side=σH_xx/σscrx_side
ηsy_side=σH_yy/σscry_side
ηsz_side=τ_H/σscrz_side
...
ηux_side=σH_xx/σucrx_side1
ηuy_side=σH_yy/σucry_side2
ηuz_side=τ_H/σucrz_side1
...
σ_yrd=σy_rd
τ_rd=τrd
x15=(σH_xx/σ_xrd)**2+(σH_yy/σ_yrd)**2-ci_2*(σH_yy/σ_xrd)*(σH_yy/σ_yrd)+(τ_H/τ_rd)**2
...
Longitudinal=σH_xx/σxrd
Transverse=σH_yy/σy_rd
Shear=τ_H/τ_rd
Biaxial=sqrt(x15)
