...
| `hull_girder_screening` | `src/digitalmodel/hull_girder_screening/` | `tests/naval_architecture/test_hull_girder_screening.py` | `docs/domains/ship-design/hull-girder-strength-screening.md` | Hull-girder still-water SF/BM screening vs allowable curves + section-modulus check (box / Bonjean-table / direct buoyancy) | NumPy, PNA/Hughes longitudinal strength |
