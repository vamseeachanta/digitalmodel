...
| `report_pack` | `src/digitalmodel/report_pack/` | `tests/report_pack/` | `docs/domains/reporting/standard-report-pack.md` | Standard marine engineering report pack (md + self-contained html + optional pdf, citations sidecar, provenance manifest) | pandas, matplotlib |
