...
python execute_orcawave_parallel.py --config ../../../../docs/modules/orcawave/L01_aqwa_benchmark/orcawave_001_ship_raos_rev2.yml
```
...
python execute_orcawave_parallel.py \
    --config ../../../../docs/modules/orcawave/L01_aqwa_benchmark/orcawave_001_ship_raos_rev2.yml \
    --dry-run
