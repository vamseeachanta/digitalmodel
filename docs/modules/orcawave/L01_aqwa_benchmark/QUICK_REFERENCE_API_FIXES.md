...
**Command**:
```bash
cd D:/workspace-hub/digitalmodel/docs/modules/orcawave/examples/L01_default_vessel/
...
### 1. Diagnostic Script
**Location**: `docs/modules/orcawave/examples/L01_default_vessel/diagnose_orcawave_api.py`
...
**Location**: `docs/modules/orcawave/examples/L01_default_vessel/run_orcawave_diffraction_improved.py`
...
**Location**: `docs/modules/orcawave/L01_aqwa_benchmark/ROOT_CAUSE_ANALYSIS.md`
