...
|------------------|-------------------------|
| L01_default_vessel | `docs/modules/orcaflex/examples/raw/L01/L01 Default vessel.yml` |
| L02 OC4 Semi-sub | `docs/modules/orcaflex/examples/raw/L02/L02 OC4 Semi-sub.yml` |
| L03 Semi-sub multibody analysis | `docs/modules/orcaflex/examples/raw/L03/L03 Semi-sub multibody analysis.yml` |
| L04 Sectional bodies | `docs/modules/orcaflex/examples/raw/L04/L04 Sectional bodies.yml` |
| L05 Panel pressures | `docs/modules/orcaflex/examples/raw/L05/L05 Panel pressures.yml` |
