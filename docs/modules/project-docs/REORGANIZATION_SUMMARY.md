...
```bash
# Profiling
python -m digitalmodel.marine_ops.marine_analysis profile --module <name>

# Extraction
python -m digitalmodel.marine_ops.marine_analysis extract --type <ocimf|hydro|mooring>

# Validation
python -m digitalmodel.marine_ops.marine_analysis validate --phase <1|2|3>

# Visualization
python -m digitalmodel.marine_ops.marine_analysis visualize --type <integration|ocimf|performance>

# Analysis
python -m digitalmodel.marine_ops.marine_analysis analyze --input <file>
```
