...
- `docs/modules/standards/FILE_ORGANIZATION_STANDARDS.md` - File organization rules
- `docs/modules/standards/TESTING_FRAMEWORK_STANDARDS.md` - Testing standards
- `docs/modules/workflow/DEVELOPMENT_WORKFLOW.md` - Development workflow
