...
# Load a base model
model = OrcFxAPI.Model('docs/modules/orcaflex/templates/mooring_systems/calm_buoy_hybrid/base/calm_buoy_base.yml')
...
model = OrcFxAPI.Model('docs/modules/orcaflex/templates/mooring_systems/calm_buoy_hybrid/cases/case_deep_water.yml')
