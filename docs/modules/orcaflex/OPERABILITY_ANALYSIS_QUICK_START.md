...
```bash
# Edit: examples/calm_buoy/north_sea_calm_project_human.yml
...
### Full Documentation:
- **Implementation Guide**: `docs/modules/orcaflex/OPERABILITY_ANALYSIS_IMPLEMENTATION.md`
- **Proposal (Background)**: `docs/modules/orcaflex/OPERABILITY_ANALYSIS_PROPOSAL.md`
- **Metocean Data Sources**: `docs/modules/orcaflex/NORTH_SEA_METOCEAN_DATA_SOURCES.md`

### Example Files:
- **North Sea Example**: `examples/calm_buoy/north_sea_calm_project_human.yml`
