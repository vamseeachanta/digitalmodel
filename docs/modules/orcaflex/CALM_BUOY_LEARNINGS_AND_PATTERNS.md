...
✅ **Example files** - C06 CALM Buoy reference (docs/modules/orcaflex/mooring/buoy/C06 CALM Buoy/)
...
2. **CALM Buoy Example**: `docs/modules/orcaflex/mooring/buoy/C06 CALM Buoy/`
3. **User Prompt**: `docs/modules/orcaflex/mooring/buoy/C06 CALM Buoy/user_prompt.md`
