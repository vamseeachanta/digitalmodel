...
The `digitalmodel.marine_analysis.python_code_passing_ship` module provides a comprehensive API for calculating hydrodynamic interaction forces between passing vessels.
...
```python
from digitalmodel.marine_analysis.python_code_passing_ship.configuration import VesselConfig
```
...
```python
from digitalmodel.marine_analysis.python_code_passing_ship.configuration import EnvironmentConfig
```
...
```python
from digitalmodel.marine_analysis.python_code_passing_ship.configuration import CalculationConfig
```
...
```bash
# Show help
python -m digitalmodel.marine_analysis.python_code_passing_ship --help

# Single calculation
python -m digitalmodel.marine_analysis.python_code_passing_ship \
    --config config.yaml \
...
```python
from digitalmodel.marine_analysis.python_code_passing_ship.exceptions import (
    ConfigurationError,
    CalculationError,
    ConvergenceError,
    ValidationError
...
```python
from digitalmodel.ship_design import ShipDesigner
from digitalmodel.marine_analysis.python_code_passing_ship import PassingShipCalculator
...
```python
from digitalmodel.mooring_analysis import MooringAnalyzer
from digitalmodel.marine_analysis.python_code_passing_ship import PassingShipCalculator
...
```python
from digitalmodel.marine_analysis.python_code_passing_ship import __version__
...
```python
from digitalmodel.marine_analysis.python_code_passing_ship.constants import (
