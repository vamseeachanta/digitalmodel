...
**Related references:**
- Latest-only extracts: `docs/modules/pipecapacity/WALL_THICKNESS_LATEST_ONLY.md`
- Latest-only LaTeX: `docs/modules/pipecapacity/WALL_THICKNESS_LATEST_ONLY_LATEX.md`
- Latest-to-older extracts: `docs/modules/pipecapacity/WALL_THICKNESS_LATEST_TO_OLDER.md`
- OCR inventory: `docs/modules/pipecapacity/WALL_THICKNESS_CODES_ONLY.md`
