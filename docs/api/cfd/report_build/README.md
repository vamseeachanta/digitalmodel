...
Scripts that produced the interactive versions of the 5 verification reports.
All chart data and animation frames are computed from real OpenFOAM v2312
solves of the archived cases under `../cases/` — nothing is hand-entered.
